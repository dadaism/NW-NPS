/*
* File:  needle_rodinia_opt.cu
* Author: Da Li
* Email:  da.li@mail.missouri.edu
* Organization: Networking and Parallel Systems Lab (http://nps.missouri.edu/)
*
* Description: This file is optimized implementation of Rodinia benchmark on GPU.
*
*/
#include <stdlib.h>
#include <stdio.h>
...
void runTest( int argc, char** argv) 
{
	...
	unsigned int *d_pos_matrix, *d_dim_matrix;
	int *d_score_matrix;
